            ...
            <form onSubmit={handleForgotSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleForgotChange("username", e.target.value)
                  }
                  className="w-full border rounded px-3 py-2 text-gray-500 placeholder-gray-400"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleForgotChange("employeeNumber", e.target.value)
                  }
                  className="w-full border rounded px-3 py-2 text-gray-500 placeholder-gray-400"
              ...
              {forgotStatus && (
                <div className="text-sm text-gray-500">{forgotStatus}</div>
              )}
              <div className="flex gap-2 mt-4">
                ...
                <button
                  type="button"
                  className="bg-gray-300 px-4 py-2 rounded text-gray-500"
                  onClick={() => {
